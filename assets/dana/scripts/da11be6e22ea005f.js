...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('header.nav .logo-img').forEach(function (logo) {
    logo.src = 'assets/dana/media/20f23820f8d1a4be.svg';
  });
  document.querySelectorAll('footer.site .logo-img').forEach(function (logo) {
    logo.src = 'assets/dana/media/5490b1fa8be0869f.svg';
  });
  var mobileLogo = document.querySelector('.m-overlay .logo-img');
  if (mobileLogo) mobileLogo.src = 'assets/dana/media/1cf43ea71ccf6ac2.svg';
